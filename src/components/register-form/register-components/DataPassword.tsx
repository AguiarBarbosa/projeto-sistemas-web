...
export const DataPassword = ({ password, onChange }: DataPasswordProps) => {
  ...
  return (
    <>
      ...
      <input
        ...
        className={`p-2 pl-10 border rounded-lg w-full focus:outline-greenpersonal focus:bg-green-50 ${password ? 'bg-green-50 border-greenpersonal' : ''}`}
        required
      />
